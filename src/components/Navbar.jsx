...
const Navbar = () => {
	...
	return (
		<div
			className={`${styles.paddingX} relative flex w-full items-center justify-between py-10`}
		>
			{/* gradient */}
			<div
				className={`${
					isOpen ? 'opacity-100' : 'opacity-0'
				} gradient absolute left-0 top-0 -z-10 block h-screen w-screen transition duration-300 sm:hidden`}
			></div>
